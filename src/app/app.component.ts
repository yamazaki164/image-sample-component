...
export class AppComponent {
  ...
  rotate(angle: number) {
    ...
    this.image2.src = this.rotateImage(image, angle);
  }

  private rotateImage(image: HTMLImageElement, angle: number): string {
    ...
    context.translate(image.height * 0.5, image.width * 0.5);
